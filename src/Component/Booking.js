                ...
                {loading ? (
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="number" className="form-control" name="load_weight" placeholder="Enter load weight" required style={{ borderRadius: '8px' }} min="1" />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="date" className="form-control" name="date" required style={{ borderRadius: '8px' }} />
                        </div>

                        <div className="mb-4">
                            <label className="form-label">Time</label>
                            <input type="time" className="form-control" name="time" required style={{ borderRadius: '8px' }} />
                        </div>
